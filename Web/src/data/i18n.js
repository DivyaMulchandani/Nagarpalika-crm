export const T = {
  en: {
    'brand.title': 'Patan Nagarpalika · Online Job Application System',
    'brand.sub': 'Patan Municipality (Govt. of Gujarat) · પાટણ નગરપાલિકા (ગુજરાત સરકાર)',
    'util.skip': 'Skip to Main', 'util.screen': 'Screen Reader', 'util.az': 'A+ A-',
    'nav.home': 'HOME', 'nav.about': 'ABOUT',
    'nav.careers': 'CAREERS / ભરતી', 'nav.registration': 'Registration',
    'nav.notices': 'NOTICES', 'nav.results': 'RESULT',
    'nav.callletter': 'CALL LETTER', 'nav.contact': 'CONTACT', 'nav.login': 'Login',
    'ft.brand': 'Patan Nagarpalika — Online Job Application System',
    'ft.about': 'An initiative of Patan Nagarpalika (Govt. of Gujarat). The portal lists official notifications, public functions, and online recruitment.',
    ...
    'home.welcome.h': 'Patan Nagarpalika — Citizen & Recruitment Portal',
    'home.welcome.guj': 'પાટણ નગરપાલિકા — નાગરિક અને ભરતી પોર્ટલ',
  ...
  hi: {
    'brand.title': 'पाटण नगरपालिका · ऑनलाइन नौकरी आवेदन प्रणाली',
    'brand.sub': 'पाटण नगरपालिका (गुजरात सरकार) · પાટણ નગરપાલિકા (ગુજરાત સરકાર)',
    'util.skip': 'मुख्य सामग्री पर जाएँ', 'util.screen': 'स्क्रीन रीडर', 'util.az': 'A+ A-',
    'nav.home': 'मुखपृष्ठ', 'nav.about': 'परिचय',
    'nav.careers': 'भर्ती', 'nav.registration': 'पंजीकरण',
    'nav.notices': 'सूचनाएँ', 'nav.results': 'परिणाम',
    'nav.callletter': 'कॉल लेटर', 'nav.contact': 'संपर्क', 'nav.login': 'लॉगिन',
    'ft.brand': 'पाटण नगरपालिका — ऑनलाइन नौकरी आवेदन प्रणाली',
    'ft.about': 'पाटણ नगरपालिका (गुजरात सरकार) की पहल। यह पोर्टल आधिकारिक सूचनाएँ, सार्वजनिक कार्यक्रम और ऑनलाइन भर्ती सूचीबद्ध करता है।',
    ...
    'home.welcome.h': 'पाटण नगरपालिका — नागरिक एवं भर्ती पोर्टल',
    'home.welcome.guj': 'પાટણ નગરપાલિકા — નાગરિક અને ભરતી પોર્ટલ',
  ...
  gu: {
    'brand.title': 'પાટણ નગરપાલિકા · ઓનલાઇન જોબ એપ્લિકેશન સિસ્ટમ',
    'brand.sub': 'પાટણ નગરપાલિકા (ગુજરાત સરકાર) · Patan Municipality (Govt. of Gujarat)',
    'util.skip': 'મુખ્ય સામગ્રી પર જાઓ', 'util.screen': 'સ્ક્રીન રીડર', 'util.az': 'A+ A-',
    'nav.home': 'મુખપૃષ્ઠ', 'nav.about': 'પરિચય',
    'nav.careers': 'ભરતી', 'nav.registration': 'નોંધણી',
    'nav.notices': 'સૂચનાઓ', 'nav.results': 'પરિણામ',
    'nav.callletter': 'કૉલ લેટર', 'nav.contact': 'સંપર્ક', 'nav.login': 'લૉગિન',
    'ft.brand': 'પાટણ નગરપાલિકા — ભરતી પોર્ટલ',
    'ft.about': 'પાટણ નગરપાલિકા અને શહેરી વિકાસ વિભાગની પહેલ. આ પોર્ટલ સત્તાવાર સૂચનાઓ, જાહેર કાર્યક્રમો અને ઓનલાઇન ભરતી સૂચિબદ્ધ કરે છે.',
    ...
    'home.welcome.h': 'પાટણ નગરપાલિકા — નાગરિક અને ભરતી પોર્ટલ',
    'home.welcome.guj': 'Patan Nagarpalika — Citizen & Recruitment Portal',
