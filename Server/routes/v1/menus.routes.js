 ...
 *         description: Unauthorized
 */
router.post("/menus", authMiddleware(["ADMIN", "EMPLOYEE", "DOCTOR"]), createMenuMaster);
 ...
 */
router.get("/menus", authMiddleware(["ADMIN", "EMPLOYEE", "DOCTOR"]), getAllMenuMasters);
 ...
 */
router.get("/menus/test", authMiddleware(["ADMIN", "EMPLOYEE", "DOCTOR"]), getMenuTest);
