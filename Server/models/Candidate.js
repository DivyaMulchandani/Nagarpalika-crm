...
const CandidateSchema = new mongoose.Schema(
  {
    ...
    dob: { type: Date },
    gender: { type: mongoose.Schema.Types.ObjectId, ref: "MasterData" },
    ...
    marital_status: { type: mongoose.Schema.Types.ObjectId, ref: "MasterData" },
    ph_status: { type: Boolean, default: false },
    ph_type: { type: mongoose.Schema.Types.ObjectId, ref: "MasterData" },
    ph_percentage: { type: Number },
    ex_serviceman: { type: Boolean, default: false },
    qualification: { type: mongoose.Schema.Types.ObjectId, ref: "MasterData" },
    languages: [
      {
        language: { type: mongoose.Schema.Types.ObjectId, ref: "MasterData" },
